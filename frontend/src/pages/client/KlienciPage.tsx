...
import KlientForm from '@/components/client/form/KlientForm';
import ImportKlientow from '@/pages/client/ImportKlientow'; // ✅ Dodaj import
...
const KlienciPage = () => {
    ...
    const [isImportVisible, setIsImportVisible] = useState(false); // ✅ Nowy state
    ...
    const handleImport = () => {
        setIsImportVisible(true); // ✅ Otwórz import
    };
    ...
    const handleImportClose = () => {
        ...
        fetchKlienci(); // ✅ Odśwież listę po imporcie
    };
    ...
    return (
        <div className="page-container">
            ...
            {isImportVisible && (
                <ImportKlientow onClose={handleImportClose} /> // ✅ Nowy komponent
            )}
            ...
            <div className="action-buttons">
                ...
                <button className="btn btn-secondary" onClick={handleImport}> {/* ✅ Dodaj onClick */}
                    📤 Importuj
                </button>
